...
import { type PinionContext, renderTemplate, toFile } from '@feathersdev/pinion'
...
import type { PinionContext } from '@feathersdev/pinion'
...
import { input } from '@inquirer/prompts'
import { type PinionContext, after, inject, prepend, renderTemplate, toFile } from '@feathersdev/pinion'
...
import { type PinionContext, exec } from '@feathersdev/pinion'
...
import { type PinionContext, runGenerators } from '@feathersdev/pinion'
...
```ts
import { getContext } from '@feathersdev/pinion'
...
```ts
import { type Callable, type PinionContext, getCallable, toFile } from '@feathersdev/pinion'
...
Pinion has a small API with only a few tasks necessary to build powerful generators and CLI tools. Everything below is exported from `@feathersdev/pinion`.
...
```ts
import { type PinionContext, renderTemplate, toFile, when } from '@feathersdev/pinion'
...
```ts
import { type PinionContext, append, before, inject, prepend, toFile } from '@feathersdev/pinion'
...
```ts
import { type PinionContext, copyFiles, fromFile, toFile } from '@feathersdev/pinion'
...
```ts
import { type PinionContext, toFile, writeJSON } from '@feathersdev/pinion'
...
import { type PinionContext, fromFile, loadJSON, toFile, writeJSON } from '@feathersdev/pinion'
...
```ts
import { type PinionContext, runGenerator } from '@feathersdev/pinion'
